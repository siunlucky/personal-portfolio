    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/faiz_elfahad.jpg"
              alt="Faiz Elfahad Kurniawan"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Faiz.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span>
        <span className="font-bold"></span> I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">React (Next.js)</span> and <span className="underline">Laravel</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/faiz-elfahad-kurniawan-427685232/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/siunlucky"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
